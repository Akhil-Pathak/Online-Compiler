...
const { Job } = require("../../compiler/compiler_model");
const { Problem } = require("../../compiler/compiler_model");
...
jobQueue.process(NUM_WORKERS, async ({ data }) => {
  ...
  try {
    if (job.probID != undefined) {
      ...
      execOutput = await executeCode(job.filepath, job.input, job.language, DEFAULT_MEM_LIMIT, "NORMAL_EXECUTION");
